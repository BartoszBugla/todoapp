...
/* harmony import */ var _redux_actions_todosActions__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../redux/actions/todosActions */ "./redux/actions/todosActions.js");
/* harmony import */ var _dumb_Select__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../dumb/Select */ "./components/dumb/Select.js");
/* harmony import */ var _formItem__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./formItem */ "./components/dumb/formItem.js");
/* harmony import */ var _customHooks_formHook__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../customHooks/formHook */ "./customHooks/formHook.js");
var __jsx = react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement;
...
const ModalItem = styled_components__WEBPACK_IMPORTED_MODULE_1___default()(_formItem__WEBPACK_IMPORTED_MODULE_6__["default"]).withConfig({
...
const Todo = ({
  ...
  const convertedHour = Object(_customHooks_convertDate__WEBPACK_IMPORTED_MODULE_3__["default"])(hour, minute, ":");
  const {
    setInputs,
    inputs,
    handleInputChange
  } = Object(_customHooks_formHook__WEBPACK_IMPORTED_MODULE_7__["useForms"])();
  ...
  const deleteThis = e => {
    e.preventDefault();
    dispatch(Object(_redux_actions_todosActions__WEBPACK_IMPORTED_MODULE_4__["deleteTodo"])(_id));
  }; //edit action


  const editThis = e => {
    e.preventDefault();
    dispatch(Object(_redux_actions_todosActions__WEBPACK_IMPORTED_MODULE_4__["editTodo"])(_id, editPayload));
    switchEdit();
  };

  const checkThis = e => {
    e.preventDefault();
    dispatch(Object(_redux_actions_todosActions__WEBPACK_IMPORTED_MODULE_4__["checkTodo"])(_id, {
      done: !done
    }));
  };
  ...
  const {
    0: isEdit,
    1: setIsEdit
  } = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(false); //initial input values
  ...
  if (isEdit) {
    ...
    }, __jsx(_dumb_Select__WEBPACK_IMPORTED_MODULE_5__["default"], {
      name: "hour",
      value: inputs.hour,
...
/* harmony import */ var react_redux__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! react-redux */ "react-redux");
/* harmony import */ var react_redux__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(react_redux__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _dumb_formItem__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../dumb/formItem */ "./components/dumb/formItem.js");
...
/* harmony import */ var _dumb_Select__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../dumb/Select */ "./components/dumb/Select.js");
/* harmony import */ var _dumb_Todo__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../dumb/Todo */ "./components/dumb/Todo.js");
/* harmony import */ var _redux_actions_types__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../redux/actions/types */ "./redux/actions/types.js");
/* harmony import */ var _redux_actions_todosActions__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../redux/actions/todosActions */ "./redux/actions/todosActions.js");
/* harmony import */ var _customHooks_formHook__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../customHooks/formHook */ "./customHooks/formHook.js");
var __jsx = react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement;
...
const Title = styled_components__WEBPACK_IMPORTED_MODULE_1___default.a.h6.withConfig({
  displayName: "AddTodoModal__Title",
  componentId: "sc-1wbi0hq-4"
})(["font-size:26px;text-align:center;width:100%;font-family:\"Jost\";"]);
const ModalItem = styled_components__WEBPACK_IMPORTED_MODULE_1___default()(_dumb_formItem__WEBPACK_IMPORTED_MODULE_3__["default"]).withConfig({
  displayName: "AddTodoModal__ModalItem",
  componentId: "sc-1wbi0hq-5"
})(["color:black;&::placeholder{color:#888888 !important;}"]);
const Horizntally = styled_components__WEBPACK_IMPORTED_MODULE_1___default.a.div.withConfig({
...
const AddTodoModal = () => {
  const dispatch = Object(react_redux__WEBPACK_IMPORTED_MODULE_2__["useDispatch"])();
  const userID = Object(react_redux__WEBPACK_IMPORTED_MODULE_2__["useSelector"])(state => state.Auth.user._id);
  const open = Object(react_redux__WEBPACK_IMPORTED_MODULE_2__["useSelector"])(state => state.modal.open);

  const hide = () => {
    dispatch({
      type: _redux_actions_types__WEBPACK_IMPORTED_MODULE_7__["CLOSE_MODAL"]
    });
  };
  ...
  const {
    ...
    inputs,
    handleInputChange
  } = Object(_customHooks_formHook__WEBPACK_IMPORTED_MODULE_9__["useForms"])();
  const init = Object(react_redux__WEBPACK_IMPORTED_MODULE_2__["useSelector"])(state => state.modal);
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(() => {
  ...
  const handleSubmit = e => {
    ...
    dispatch(Object(_redux_actions_todosActions__WEBPACK_IMPORTED_MODULE_8__["addTodo"])(body));
  };
  ...
  return __jsx(Container, null, __jsx(BG, {
  ...
  }), __jsx(Horizntally, null, __jsx(_dumb_Select__WEBPACK_IMPORTED_MODULE_5__["default"], {
    name: "day",
    value: inputs.day,
    onChange: handleInputChange,
    type: "number",
    ...
    startNumber: "0",
    lastNumber: "59"
  })), __jsx("p", null, "Podgl\u0105d"), __jsx(_dumb_Todo__WEBPACK_IMPORTED_MODULE_6__["default"], {
    todos: inputs
  }), __jsx(_dumb_SubmitButton__WEBPACK_IMPORTED_MODULE_4__["default"], null, " Dodaj"))));
};
...
const Day = styled_components__WEBPACK_IMPORTED_MODULE_1___default.a.p.withConfig({
...
const DayPage = ({
  ...
  const date = Object(_customHooks_convertDate__WEBPACK_IMPORTED_MODULE_3__["default"])(day, month, ".");
...
const Circle = styled_components__WEBPACK_IMPORTED_MODULE_1___default.a.div.withConfig({
  displayName: "Navbar__Circle",
  componentId: "egy66p-1"
})(["width:50px;height:50px;border-radius:50%;background-color:grey;"]);
const NameItem = styled_components__WEBPACK_IMPORTED_MODULE_1___default.a.div.withConfig({
...
const Navbar = () => {
  const {
    name,
    lastName
  } = Object(react_redux__WEBPACK_IMPORTED_MODULE_2__["useSelector"])(state => state.Auth.user);
  const dispatch = Object(react_redux__WEBPACK_IMPORTED_MODULE_2__["useDispatch"])();
...
const Styles = styled_components__WEBPACK_IMPORTED_MODULE_1___default.a.ul.withConfig({
...
const TodosList = () => {
  let todos = Object(react_redux__WEBPACK_IMPORTED_MODULE_4__["useSelector"])(state => state.todos); //! amount of cards
  ...
  for (let i = 0; i < limit; i++) {
    ...
    Items.push(__jsx(_DayPage__WEBPACK_IMPORTED_MODULE_2__["default"], {
      ...
      day: day,
      month: month
    }, passedTodos.map(i => __jsx(_dumb_Todo__WEBPACK_IMPORTED_MODULE_3__["default"], {
      todo: i
    }))));
  }
...
const getTodos = (userID, token) => {
  let res;
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(`http://localhost:5000/todos/${userID}`, {}, tokenConfig(token)).then(r => {
    res = r;
  }).catch(e => {
    res = e;
  });
...
const addTodo = (body, token) => {
  let res;
  console.log(body);
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.post("http://localhost:5000/todos", body, tokenConfig(token)).then(r => {
    res = r;
  }).catch(e => {
    res = e;
    console.log(e);
...
module.exports = __webpack_require__(/*! C:\Users\Bartosz\Desktop\TodoApp\pages\dashboard.js */"./pages/dashboard.js");
